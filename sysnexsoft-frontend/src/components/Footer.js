    ...
    return (
        <div className="it-company-footer it-company-bg-two pt-120 position-relative z-1">
                    ...
                    <div className="row justify-content-between">
                        <div className="col-xl-3 col-lg-5">
                            <div className="footer-single-col">
                                <img src="/assets/img/it_company/logo.png" alt="" />
                                    <p className="flh-24 mt-20 mb-30">Interactively disseminate client-based
                                        functionalities and
                                    ...
                                    <ul className="list-unstyled list-inline footer-social-list d-flex mb-0">
                                        <li className="list-inline-item"><Link href="#" className="bgc-white risk-color"><i
                                            className="fab fa-facebook-f"></i></Link></li>
                                        <li className="list-inline-item"><Link href="#" className="bgc-white risk-color"><i
                                            className="fab fa-instagram"></i></Link></li>
                                        <li className="list-inline-item"><Link href="#" className="bgc-white risk-color"><i
                                            className="fab fa-dribbble"></i></Link></li>
                                        <li className="list-inline-item"><Link href="#" className="bgc-white risk-color"><i
                        ...
                        <div className="col-xl-3 col-lg-5">
                            <div className="footer-single-col pl-40">
                                ...
                                <ul className="list-unstyled footer-nav-list mb-lg-0">
                                    ...
                                    <li><Link href="/blogs" className="text-decoration-none">Blog</Link></li>
                                    <li><Link href="/projects" className="text-decoration-none">Projects</Link>
                                    </li>
                                    <li><Link href="/contact-us" className="text-decoration-none">Contact</Link></li>
                                    <li><Link href="/about-us" className="text-decoration-none">About Us</Link>
                                    </li>
                                    <li><Link href="service-single.html" className="text-decoration-none">Services
                                        Single</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-5">
                            <div className="footer-single-col pr-20">
                                ...
                                <ul className="list-unstyled footer-nav-list mb-lg-0">
                                    ...
                                    <li className="mt-30"><Link href="blog-single.html" className="">View Google Map</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-5">
                            <div className="footer-single-col">
                                ...
                                <p className="flh-24">Sign up for our latest news &amp; articles. We won’t
            ...
            <div className="rm-footer-bottom text-center pt-80 pb-30">
                <p className="it-company-color fs-16 ff-risk-pri flh-24 mb-0">Copyright @2023 All Rights Reserved by
                    <Link className="it-company-color fw-700" href="#">ThemeTags</Link>
                </p>
            </div>
        </div>
    );
