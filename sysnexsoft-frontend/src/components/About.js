            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-5">
                        <h2 className="it-company-title it-company-color fs-40 fw-600 flh-56 mb-80">Since 2013, we have
                            been
                    ...
                    <img src="assets/img/it_company/shape/hero.png" alt="" className="s-one position-absolute" />
                        <div className="row justify-content-between">
                            <div className="col-xxl-4 col-xl-5 col-lg-6 col-md-8 col-sm-10">
                                <div
                                    className="it-company-about-testimonial it-company-bg-three rounded-16 position-relative">
                                    <img src="assets/img/it_company/about_testi_icon.png" alt="" className="mb-20"/>
                                        <p className="it-company-color fw-500 flh-24 mb-20">If you always do what you've
                                            always done,
                                            you'll
                                            always
                            ...
                            <div className="col-xxl-7 col-xl-6">
                                <div
                                    className="it-company-about-box it-company-bg d-inline-flex align-items-center gap-5 rounded-16 p-5">
                                    ...
                                    <div className="it-about-content">
                                        ...
                                        <p className="text-white flh-24 fch-40 mb-0">Enthusiastically myocardinate
                                            technically sound
                                            innovation
                                ...
                                <div className="d-inline-block pl-40">
                                    <h6 className="clr-paragraph fs-20 fw-600 flh-28 mt-40">Distinctively initiate viral
                                        ideas for
                                        goal-oriented
                                        <br/>
                                    ...
                                    <div className="d-flex align-items-center flex-wrap gap-20 mt-30">
                                        <a href="#"
                                           className="btn it-company-bg ca-two-bg-hover-two rounded-5 text-white fs-16">About
                                            US</a>
                                        <div className="it-company-social-area d-flex align-items-center gap-4">
                                            ...
                                            <div className="it-company-social-icons d-flex align-items-center">
                                                <a href="#"
                                                   className="it-com-link risk-color rounded-8 it-company-bg-hover it-company-hover-color d-flex align-items-center justify-content-center"><i
